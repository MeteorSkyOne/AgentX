...
vi.mock("./WorkspaceFileBrowser", () => ({
  useWorkspaceFileBrowser: (args: { workspaceID?: string; workspacePath?: string }) => {
    ...
    return {
      ...
      canSearchWorkspace: Boolean(args.workspaceID),
      tabs: [],
      activeTabId: null,
      ...
      setSearchCaseSensitive: () => undefined,
      setSearchRegex: () => undefined,
      setSearchWholeWord: () => undefined,
      ...
      setGitHistoryMode: () => undefined,
      setGitHistoryQuery: () => undefined,
      setActiveTabEditorViewState: () => undefined,
      saveTabEditorViewState: () => undefined,
      saveTabMarkdownPreviewScrollTop: () => undefined,
      loadTree: workspaceBrowserMock.loadTree,
      loadDirectory: async () => undefined,
      loadSearch: async () => undefined,
      clearSearch: () => undefined,
      loadFile: workspaceBrowserMock.loadFile,
      loadGitStatus: async () => undefined,
      loadGitHistory: async () => undefined,
      selectGitCommit: async () => undefined,
...
function shellProps(): ShellProps {
  ...
  return {
    ...
    onUpdateSelfUpdateSettings: vi.fn(),
    onCheckSelfUpdate: vi.fn(),
    onRunSelfUpdate: vi.fn(),
    ...
    onLoadWorkspaceGitHistory: vi.fn(),
